...
export default (function () {
    ...
    var AlloyFinger = function (el, option) {
        ...
        if(!hasTouch){
	        ...
	        this.element.addEventListener("mousecancel", this.cancel, false);
        }
    ...
    AlloyFinger.prototype = {
        ...
        move: function (evt) {
            ...
            if (len > 1) {
        		...
        		let touches = evt.touches || [];
        		let changedTouches = evt.changedTouches || evt;
...
//          this.element.removeEventListener("touchcancel", this.cancel);
	        ...
	        if(!hasTouch){
		        ...
		        this.element.removeEventListener("mousecancel", this.cancel);
	        }
