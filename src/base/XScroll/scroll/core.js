...
export function coreMixin(BScroll) {
  ...
  BScroll.prototype._transitionProperty = function (property = 'transform') {
    ...
    this.domPlayStyle[style.transitionProperty] = property
  }

  BScroll.prototype._transitionTime = function (time = 0) {
    this.scrollerStyle[style.transitionDuration] = time + 'ms'

    this.domPlayStyle[style.transitionDuration] = time + 'ms'
  ...
  BScroll.prototype._transitionTimingFunction = function (easing) {
	...
	this.domPlayStyle[style.transitionTimingFunction] = easing
  ...
  BScroll.prototype._translate = function (x, y) {
    ...
    if (this.options.useTransform) {
      ...
      this.domPlayStyle[style.transform] = `translate(${x}px,${y}px)${this.translateZ}`
    } else {
      x = Math.round(x)
      y = Math.round(y)
      ...
      this.domPlayStyle.left = `${x}px`
      this.domPlayStyle.top = `${y}px`
    }
