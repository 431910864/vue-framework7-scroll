        ...
        ************   Views   ************
        ...
        var View = function (selector, params) {
            ...
            view.handleTouchStart = function (e) {
                ...
                pageOnLeft = document.getElementsByClassName('page-on-left');
                for(;iswiperNumber<pageOnLeft.length;iswiperNumber++){
                		if(pageOnLeft[iswiperNumber].querySelectorAll('.iswiper').length > 0){
                			watchPage = 0;
                		}
                }
                iswiperNumber = 0;
                isOffset = e.offsetX ? e.offsetX <= 30 : touchesStart.x <= 30;
                if(typeof watchPage == "number" && watchPage == 0 && isOffset){
                		window.alowBack = true;
                }else{
                		window.alowBack = false;
                }
            };
...
export default window.Framework7;