<template>
  <f7-page>
    ...
    <div id="main" class="demo-main">
    		<!--<List v-for="(item,index) in mobiarr">
    			<select :name="index.toLowerCase()" :id="index.toLowerCase()" class="settings">
           	    <option :value="key" v-for="(vo,key) in item" v-if="typeof vo != 'object'">{{vo}}</option>
                <optgroup v-for="(vo,key) in item" :label="key" v-if="typeof vo == 'object'">
               	 <option :value="k" v-for="(v,k) in vo">{{v}}</option>
                </optgroup>
            </select>
    		</List>-->
    		<List>
    ...
    <div class="demo-wrapper demo-wrapper-numpadCurrency">
        <div class="md-stepper-np" style="display:none" mbsc-enhance>
            <div class="mbsc-padding md-demo">
                ...
                <div class="mbsc-desc ">Top up from credit card if account falls bellow mobiscroll.$10</div>
                <div>
                    <div>
...
<script>
import MobiscrollArr from 'src/common/data/Mobiscroll.json';
export default{
	data(){
		return{
			theme:'',
...
//		           	 mobiscroll.$.prototype[i] = $.prototype[i];
//		            }
		            this[demo + 'Init']();
					//console.info(demo,window,demoContainer,mobiscroll,this)
		            demoContainer.trigger('mbsc-enhance');
		            //console.info(mobiscroll,$.prototype)
		            //console.info(mobiscroll,$.prototype)
		        }
		        ...
		        function resetOptions(component) {
		            ...
		            // reset display
		            $('#display').parent().show();
		            mobiscroll.$('#display option').show();
		
		            if (noDisplay[component] === 'partial') {
		                if (displayValue == 'modal' || displayValue == 'bubble') {
		                    $('#display').val('inline');
		                }
		                mobiscroll.$('#display option[value="modal"]').hide();
		                mobiscroll.$('#display option[value="bubble"]').hide();
	...
	methods: {
	    ...
	    // Basic usage date demo script
	     datetimeDateInit() {
            ...
            mobiscroll.$('#datetimeDate-demo').mobiscroll().date({
           ...
           $('#datetimeDate-show').click(function () {
                mobiscroll.$('#datetimeDate-demo').mobiscroll('show');
                return false;
            });

            $('#datetimeDate-clear').click(function () {
                 mobiscroll.$('#datetimeDate-demo').mobiscroll('clear');
                return false;
             });
        },
	    // Datetime with invalids demo script
	     datetimeInvalidInit() {
            ...
            // Mobiscroll Date & Time initialization
            mobiscroll.$('#datetimeInvalid-demo').mobiscroll().datetime({
                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
                mode: $('#mode').val(), // More info about mode: https://docs.mobiscroll.com/3-0-0_beta5/datetime#!opt-mode
                min: new Date(now.getFullYear(), now.getMonth(), now.getDate()), // More info about min: https://docs.mobiscroll.com/3-0-0_beta5/datetime#!opt-min
                invalid: ['w0', 'w6', '5/1', '12/24', '12/25'], // More info about invalid: https://docs.mobiscroll.com/3-0-0_beta5/datetime#!opt-invalid
                dateWheels: '|D M d|',
                timeWheels: 'HHii' // More info about timeWheels: https://docs.mobiscroll.com/3-0-0_beta5/datetime#!localization-timeWheels
            });

            $('#datetimeInvalid-show').click(function () {
               mobiscroll.$('#datetimeInvalid-demo').mobiscroll('show');
                return false;
            });

            $('#datetimeInvalid-clear').click(function () {
               mobiscroll.$('#datetimeInvalid-demo').mobiscroll('clear');
                return false;
             });
        },
	    // Basic usage time demo script
	     datetimeTimeInit() {
            // Mobiscroll Date & Time initialization
            mobiscroll.$('#datetimeTime-demo').mobiscroll().time({
                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
                mode: $('#mode').val(), // More info about mode: https://docs.mobiscroll.com/3-0-0_beta5/datetime#!opt-mode
            ...
            $('#datetimeTime-show').click(function () {
                mobiscroll.$('#datetimeTime-demo').mobiscroll('show');
                return false;
            });

            $('#datetimeTime-clear').click(function () {
                mobiscroll.$('#datetimeTime-demo').mobiscroll('clear');
                return false;
             });
        },
	    // Basic usage demo script
	     selectBasicInit() {
            ...
            mobiscroll.$('#selectBasic-demo').mobiscroll().select({
                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
                mode: $('#mode').val(), // More info about mode: https://docs.mobiscroll.com/3-0-0_beta5/select#!opt-mode
                minWidth: 200 // More info about minWidth: https://docs.mobiscroll.com/3-0-0_beta5/select#!opt-minWidth
            });

            $('#selectBasic-show').click(function () {
                mobiscroll.$('#selectBasic-demo').mobiscroll('show');
                return false;
            });

            $('#selectBasic-clear').click(function () {
                mobiscroll.$('#selectBasic-demo').mobiscroll('clear');
                return false;
            });
	    ...
	    // Group options demo script
	     selectGroupselectInit() {
	            ...
	            // Mobiscroll Select initialization
	            mobiscroll.$('#selectGroupselect-demo').mobiscroll().select({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val(), // More info about mode: https://docs.mobiscroll.com/3-0-0_beta5/select#!opt-mode
	                label: 'City', // More info about label: https://docs.mobiscroll.com/3-0-0_beta5/select#!opt-label
	                group: true, // More info about group: https://docs.mobiscroll.com/3-0-0_beta5/select#!opt-group
	                groupLabel: 'Country', // More info about groupLabel: https://docs.mobiscroll.com/3-0-0_beta5/select#!opt-groupLabel
	                width: [100, 170] // More info about width: https://docs.mobiscroll.com/3-0-0_beta5/select#!opt-width
	            });
	
	            $('#selectGroupselect-show').click(function () {
	                mobiscroll.$('#selectGroupselect-demo').mobiscroll('show');
	                return false;
	            });
	
	            $('#selectGroupselect-clear').click(function () {
	                mobiscroll.$('#selectGroupselect-demo').mobiscroll('clear');
	                return false;
	            });
	    ...
	    // Basic usage demo script
	     ratingStarsInit() {
	            ...
	            mobiscroll.$('.md-product').mobiscroll().rating({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val(), // More info about mode: https://docs.mobiscroll.com/3-0-0_beta5/rating#!opt-mode
	                label: 'Rate Item', // More info about label: https://docs.mobiscroll.com/3-0-0_beta5/rating#!opt-label
	                onSet: function (event, inst) { // More info about onSet: https://docs.mobiscroll.com/3-0-0_beta5/rating#!event-onSet
	                    $(this).closest('li').find('.md-rating').text(event.valueText + ' of 5');
	                },
	                onBeforeShow: function (event, inst) { // More info about onBeforeShow: https://docs.mobiscroll.com/3-0-0_beta5/rating#!event-onBeforeShow
	    ...
	    // Grades demo script
	     ratingGradesInit() {
	            ...
	            // Mobiscroll Rating initialization
	            mobiscroll.$('#ratingGrades-demo').mobiscroll().rating({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val(), // More info about mode: https://docs.mobiscroll.com/3-0-0_beta5/rating#!opt-mode
	                style: 'grade', // More info about style: https://docs.mobiscroll.com/3-0-0_beta5/rating#!opt-style
	                label: 'Rating' // More info about label: https://docs.mobiscroll.com/3-0-0_beta5/rating#!opt-label
	            });
	
	            $('#ratingGrades-show').click(function () {
	                mobiscroll.$('#ratingGrades-demo').mobiscroll('show');
	                return false;
	            });
	
	            $('#ratingGrades-clear').click(function () {
	                mobiscroll.$('#ratingGrades-demo').mobiscroll('clear');
	                return false;
	            });
	    ...
	    // Distance demo script
	     measurementDistanceInit() {
	        
	
	            // Mobiscroll Measurement initialization
	            mobiscroll.$('#measurementDistance-demo').mobiscroll().distance({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val() // More info about mode: https://docs.mobiscroll.com/3-0-0_beta5/measurement#!opt-mode
	            });
	
	            $('#measurementDistance-show').click(function () {
	                mobiscroll.$('#measurementDistance-demo').mobiscroll('show');
	                return false;
	            });
	
	            $('#measurementDistance-clear').click(function () {
	                mobiscroll.$('#measurementDistance-demo').mobiscroll('clear');
	                return false;
	            });
	    ...
	    // Speed demo script
	     measurementSpeedInit() {
	        
	
	            // Mobiscroll Measurement initialization
	            mobiscroll.$('#measurementSpeed-demo').mobiscroll().speed({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val() // More info about mode: https://docs.mobiscroll.com/3-0-0_beta5/measurement#!opt-mode
	            ...
	            $('#measurementSpeed-show').click(function () {
	                mobiscroll.$('#measurementSpeed-demo').mobiscroll('show');
	                return false;
	            });
	
	            $('#measurementSpeed-clear').click(function () {
	                mobiscroll.$('#measurementSpeed-demo').mobiscroll('clear');
	                return false;
	            });
	    ...
	    // Temperature demo script
	     measurementTemperatureInit() {
	        
	
	            // Mobiscroll Measurement initialization
	            mobiscroll.$('#measurementTemperature-demo').mobiscroll().temperature({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val() // More info about mode: https://docs.mobiscroll.com/3-0-0_beta5/measurement#!opt-mode
	            ...
	            $('#measurementTemperature-show').click(function () {
	                mobiscroll.$('#measurementTemperature-demo').mobiscroll('show');
	                return false;
	            });
	
	            $('#measurementTemperature-clear').click(function () {
	                mobiscroll.$('#measurementTemperature-demo').mobiscroll('clear');
	                return false;
	            });
	    ...
	    // Mass demo script
	     measurementMassInit() {
	            ...
	            // Mobiscroll Measurement initialization
	            mobiscroll.$('#measurementMass-demo').mobiscroll().mass({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val() // More info about mode: https://docs.mobiscroll.com/3-0-0_beta5/measurement#!opt-mode
	            ...
	            $('#measurementMass-show').click(function () {
	                mobiscroll.$('#measurementMass-demo').mobiscroll('show');
	                return false;
	            });
	
	            $('#measurementMass-clear').click(function () {
	                mobiscroll.$('#measurementMass-demo').mobiscroll('clear');
	                return false;
	            });
	    ...
	    // Force demo script
	     measurementForceInit() {
	        
	
	            // Mobiscroll Measurement initialization
	            mobiscroll.$('#measurementForce-demo').mobiscroll().force({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val() // More info about mode: https://docs.mobiscroll.com/3-0-0_beta5/measurement#!opt-mode
	            ...
	            $('#measurementForce-show').click(function () {
	                mobiscroll.$('#measurementForce-demo').mobiscroll('show');
	                return false;
	            });
	
	            $('#measurementForce-clear').click(function () {
	                mobiscroll.$('#measurementForce-demo').mobiscroll('clear');
	                return false;
	            });
	    ...
	    // Basic usage demo script
	     listTreelistInit() {
	            ...
	            mobiscroll.$('#listTreelist-demo').mobiscroll().treelist({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val(), // More info about mode: https://docs.mobiscroll.com/3-0-0_beta5/list#!opt-mode
	                width: [90, 160, 170], // More info about width: https://docs.mobiscroll.com/3-0-0_beta5/list#!opt-width
	                placeholder: 'Please Select ...', // More info about placeholder: https://docs.mobiscroll.com/3-0-0_beta5/list#!opt-placeholder
	            ...
	            $('#listTreelist-show').click(function () {
	                mobiscroll.$('#listTreelist-demo').mobiscroll('show');
	                return false;
	            });
	
	            $('#listTreelist-clear').click(function () {
	                mobiscroll.$('#listTreelist-demo').mobiscroll('clear');
	                return false;
	            });
	    ...
	    // Image and Text demo script
	     imageTextInit() {
	            ...
	            mobiscroll.$('#imageText-demo').mobiscroll().image({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val(), // More info about mode: https://docs.mobiscroll.com/3-0-0_beta5/image#!opt-mode
	                placeholder: 'Please Select ...', // More info about placeholder: https://docs.mobiscroll.com/3-0-0_beta5/image#!opt-placeholder
	                labels: ['Make'], // More info about labels: https://docs.mobiscroll.com/3-0-0_beta5/image#!opt-labels
	                enhance: true, // More info about enhance: https://docs.mobiscroll.com/3-0-0_beta5/image#!opt-enhance
	                defaultValue: ['Citroen'] // More info about defaultValue: https://docs.mobiscroll.com/3-0-0_beta5/image#!opt-defaultValue
	            });
	
	            $('#imageText-show').click(function () {
	                mobiscroll.$('#imageText-demo').mobiscroll('show');
	                return false;
	            });
	
	            $('#imageText-clear').click(function () {
	                mobiscroll.$('#imageText-demo' + '_dummy').val('');
	                return false;
	            });
	    ...
	    // Image Only demo script
	     imageBasicInit() {
	            ...
	            // Mobiscroll Image initialization
	            mobiscroll.$('#imageBasic-demo').mobiscroll().image({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val(), // More info about mode: https://docs.mobiscroll.com/3-0-0_beta5/image#!opt-mode
	                cssClass: 'md-image-fruit',
	                labels: ['Select Favorite Fruit'], // More info about labels: https://docs.mobiscroll.com/3-0-0_beta5/image#!opt-labels
	                placeholder: 'Please Select ...', // More info about placeholder: https://docs.mobiscroll.com/3-0-0_beta5/image#!opt-placeholder
	                width: 200, // More info about width: https://docs.mobiscroll.com/3-0-0_beta5/image#!opt-width
	                enhance: true // More info about enhance: https://docs.mobiscroll.com/3-0-0_beta5/image#!opt-enhance
	            });
	
	            $('#imageBasic-show').click(function () {
	                mobiscroll.$('#imageBasic-demo').mobiscroll('show');
	                return false;
	            });
	
	            $('#imageBasic-clear').click(function () {
	                mobiscroll.$('#imageBasic-demo' + '_dummy').val('');
	                return false;
	            });
	    ...
	    // Unordered list demo script
	     listUnorderedInit() {
	            ...
	            // Mobiscroll Treelist initialization
	            mobiscroll.$('#listUnordered-demo').mobiscroll().treelist({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val(), // More info about mode: https://docs.mobiscroll.com/3-0-0_beta5/list#!opt-mode
	                labels: ['Ingredients'], // More info about labels: https://docs.mobiscroll.com/3-0-0_beta5/list#!opt-labels
	                placeholder: 'Please Select ...', // More info about placeholder: https://docs.mobiscroll.com/3-0-0_beta5/list#!opt-placeholder
	                width: 200 // More info about width: https://docs.mobiscroll.com/3-0-0_beta5/list#!opt-width
	            });
	
	            $('#listUnordered-show').click(function () {
	                mobiscroll.$('#listUnordered-demo').mobiscroll('show');
	                return false;
	            });
	
	            $('#listUnordered-clear').click(function () {
	                mobiscroll.$('#listUnordered-demo').mobiscroll('clear');
	                return false;
	            });
	    ...
	    // With time scroller demo script
	     calendarTimeInit() {
	            ...
	            mobiscroll.$('#calendarTime-demo').mobiscroll().calendar({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val(), // More info about mode: https://docs.mobiscroll.com/3-0-0_beta5/calendar#!opt-mode
	                controls: ['calendar', 'time'], // More info about controls: https://docs.mobiscroll.com/3-0-0_beta5/calendar#!opt-controls
	                showScrollArrows: true // More info about showScrollArrows: https://docs.mobiscroll.com/3-0-0_beta5/calendar#!opt-showScrollArrows
	            });
	
	           $('#calendarTime-show').click(function () {
	                mobiscroll.$('#calendarTime-demo').mobiscroll('show');
	                return false;
	            });
	
	            $('#calendarTime-clear').click(function () {
	                mobiscroll.$('#calendarTime-demo').mobiscroll('clear');
	                return false;
	            });
	    ...
	    // Basic usage demo script
	     calendarBasicInit() {
	            ...
	            // Mobiscroll Calendar initialization
	            mobiscroll.$('#calendarBasic-demo').mobiscroll().calendar({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val() // More info about mode: https://docs.mobiscroll.com/3-0-0_beta5/calendar#!opt-mode
	            ...
	            $('#calendarBasic-show').click(function () {
	                mobiscroll.$('#calendarBasic-demo').mobiscroll('show');
	                return false;
	            });
	
	            $('#calendarBasic-clear').click(function () {
	                mobiscroll.$('#calendarBasic-demo').mobiscroll('clear');
	                return false;
	            });
	    ...
	    // Multi day select demo script
	     calendarMultidayInit() {
	            ...
	            // Mobiscroll Calendar initialization
	            mobiscroll.$('#calendarMultiday-demo').mobiscroll().calendar({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val(), // More info about mode: https://docs.mobiscroll.com/3-0-0_beta5/calendar#!opt-mode
	                counter: true, // More info about counter: https://docs.mobiscroll.com/3-0-0_beta5/calendar#!opt-counter
	                select: 'multiple', // More info about select: https://docs.mobiscroll.com/3-0-0_beta5/calendar#!opt-select
	                defaultValue: [new Date(year, month, 1), new Date(year, month, 2), new Date(year, month, 10)] // More info about defaultValue: https://docs.mobiscroll.com/3-0-0_beta5/calendar#!opt-defaultValue
	            });
	
	            $('#calendarMultiday-show').click(function () {
	                mobiscroll.$('#calendarMultiday-demo').mobiscroll('show');
	                return false;
	            });
	
	            $('#calendarMultiday-clear').click(function () {
	                mobiscroll.$('#calendarMultiday-demo').mobiscroll('clear');
	                return false;
	            });
	    ...
	    // Multiple select demo script
	     selectMultipleInit() {
	            ...
	            // Mobiscroll Select initialization
	            mobiscroll.$('#selectMultiple-demo').mobiscroll().select({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val(), // More info about mode: https://docs.mobiscroll.com/3-0-0_beta5/select#!opt-mode
	            ...
	            $('#selectMultiple-show').click(function () {
	                mobiscroll.$('#selectMultiple-demo').mobiscroll('show');
	                return false;
	            });
	
	            $('#selectMultiple-clear').click(function () {
	                mobiscroll.$('#selectMultiple-demo').mobiscroll('clear');
	                return false;
	            });
	    ...
	    // Basic usage demo script
	     timespanBasicInit() {
	            ...
	            mobiscroll.$('#timespanBasic-demo').mobiscroll().timespan({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val(), // More info about mode: https://docs.mobiscroll.com/3-0-0_beta5/timespan#!opt-mode
	                wheelOrder: 'iiss' // More info about wheelOrder: https://docs.mobiscroll.com/3-0-0_beta5/timespan#!opt-wheelOrder
	            });
	
	            $('#timespanBasic-show').click(function () {
	                mobiscroll.$('#timespanBasic-demo').mobiscroll('show');
	                return false;
	            });
	
	            $('#timespanBasic-clear').click(function () {
	                mobiscroll.$('#timespanBasic-demo').mobiscroll('clear');
	                return false;
	            });
	    ...
	    // Day/Hour/Minute span demo script
	     timespanDhmInit() {
	            ...
	            // Mobiscroll Timespan initialization
	            mobiscroll.$('#timespanDhm-demo').mobiscroll().timespan({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val(), // More info about mode: https://docs.mobiscroll.com/3-0-0_beta5/timespan#!opt-mode
	                wheelOrder: 'ddhhii' // More info about wheelOrder: https://docs.mobiscroll.com/3-0-0_beta5/timespan#!opt-wheelOrder
	            });
	
	            $('#timespanDhm-show').click(function () {
	                mobiscroll.$('#timespanDhm-demo').mobiscroll('show');
	                return false;
	            });
	
	            $('#timespanDhm-clear').click(function () {
	                mobiscroll.$('#timespanDhm-demo').mobiscroll('clear');
	                return false;
	            });
	    ...
	    // Countdown demo script
	     timerCountdownInit() {
	            ...
	            mobiscroll.$('#timerCountdown-demo').mobiscroll().timer({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val(), // More info about mode: https://docs.mobiscroll.com/3-0-0_beta5/timer#!opt-mode
	                targetTime: 10, // More info about targetTime: https://docs.mobiscroll.com/3-0-0_beta5/timer#!opt-targetTime
	                maxWheel: 'minutes', // More info about maxWheel: https://docs.mobiscroll.com/3-0-0_beta5/timer#!opt-maxWheel
	                minWidth: 100, // More info about minWidth: https://docs.mobiscroll.com/3-0-0_beta5/timer#!opt-minWidth
	                onFinish: function () { // More info about onFinish: https://docs.mobiscroll.com/3-0-0_beta5/timer#!event-onFinish
	    ...
	    // Basic usage demo script
	     colorHxInit() {
	            ...
	            mobiscroll.$('#colorHx-demo').mobiscroll().color({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val(), // More info about mode: https://docs.mobiscroll.com/3-0-0_beta5/color#!opt-mode
	                onBeforeShow: function (event, inst) { // More info about onBeforeShow: https://docs.mobiscroll.com/3-0-0_beta5/color#!event-onBeforeShow
	                    if (mobiscroll.$(this).text()) {
	                        inst.setVal(mobiscroll.$(event.target).text());
	                    } else {
	                        mobiscroll.$(this).text('#colorHx-ff0000').css('background-color', 'red');
	                    }
	                },
	                onSet: function (event, inst) { // More info about onSet: https://docs.mobiscroll.com/3-0-0_beta5/color#!event-onSet
	                    mobiscroll.$(this).text(event.valueText).css('background-color', event.valueText);
	                }
	            });
	    ...
	    // Basic usage demo script
	     rangeBasicInit() {
	            ...
	            mobiscroll.$('#rangeBasic-demo').mobiscroll().range({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val(), // More info about mode: https://docs.mobiscroll.com/3-0-0_beta5/range#!opt-mode
	                defaultValue: [new Date(2014, 3, 10), new Date(2014, 3, 17)] // More info about defaultValue: https://docs.mobiscroll.com/3-0-0_beta5/range#!opt-defaultValue
	            });
	
	            $('#rangeBasic-show').click(function () {
	                mobiscroll.$('#rangeBasic-demo').mobiscroll('show');
	                return false;
	            });
	
	            $('#rangeBasic-clear').click(function () {
	                mobiscroll.$('#rangeBasic-demo').mobiscroll('clear');
	                return false;
	            });
	    ...
	    // Time range demo script
	     rangeTimeInit() {
	            ...
	            // Mobiscroll Range initialization
	            mobiscroll.$('#rangeTime-demo').mobiscroll().range({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val(), // More info about mode: https://docs.mobiscroll.com/3-0-0_beta5/range#!opt-mode
	                controls: ['time'], // More info about controls: https://docs.mobiscroll.com/3-0-0_beta5/range#!opt-controls
	                maxWidth: 100 // More info about maxWidth: https://docs.mobiscroll.com/3-0-0_beta5/range#!opt-maxWidth
	            });
	
	            $('#rangeTime-show').click(function () {
	                mobiscroll.$('#rangeTime-demo').mobiscroll('show');
	                return false;
	            });
	
	            $('#rangeTime-clear').click(function () {
	                mobiscroll.$('#rangeTime-demo').mobiscroll('clear');
	                return false;
	            });
	    ...
	    // Two inputs demo script
	     rangeTwoinputsInit() {
	            ...
	            // Mobiscroll Range initialization
	            mobiscroll.$('#rangeTwoinputs-demo').mobiscroll().range({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val(), // More info about mode: https://docs.mobiscroll.com/3-0-0_beta5/range#!opt-mode
	                startInput: '#rangeTwoinputs-startDate', // More info about startInput: https://docs.mobiscroll.com/3-0-0_beta5/range#!opt-startInput
	                endInput: '#rangeTwoinputs-endDate' // More info about endInput: https://docs.mobiscroll.com/3-0-0_beta5/range#!opt-endInput
	            });
	
	        },
	
	    // Events demo script
	     eventcalendarEventInit() {
	        
	
	            var now = new Date();
	
	            // Mobiscroll Event Calendar initialization
	            mobiscroll.$('#eventcalendarEvent-demo').mobiscroll().eventcalendar({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val(),
	                layout: 'liquid', // More info about layout: https://docs.mobiscroll.com/3-0-0_beta5/eventcalendar#!opt-layout
	                firstDay: 1, // More info about firstDay: https://docs.mobiscroll.com/3-0-0_beta5/eventcalendar#!localization-firstDay
	                yearChange: true, // More info about yearChange: https://docs.mobiscroll.com/3-0-0_beta5/eventcalendar#!opt-yearChange
	                calendarScroll: 'horizontal', // More info about calendarScroll: https://docs.mobiscroll.com/3-0-0_beta5/eventcalendar#!opt-calendarScroll
	                showOuterDays: true, // More info about showOuterDays: https://docs.mobiscroll.com/3-0-0_beta5/eventcalendar#!opt-showOuterDays
	                showEventCount: true, // More info about showEventCount: https://docs.mobiscroll.com/3-0-0_beta5/eventcalendar#!opt-showEventCount
	                data: [{ // More info about data: https://docs.mobiscroll.com/3-0-0_beta5/eventcalendar#!opt-data
	                    ...
	                    d: '11/2',
	                    text: 'Deposit FUTA owed through Sep if more than mobiscroll.$500',
	                    color: '#a63e14'
	                }, {
	                    d: '11/30',
	            ...
	            $('#eventcalendarEvent-show').click(function () {
	                mobiscroll.$('#eventcalendarEvent-demo').mobiscroll('show');
	                return false;
	            });
	    ...
	    // Create, remove, update demo script
	     listviewUpdateInit() {
	            ...
	            mobiscroll.$('#listviewUpdate-demo').mobiscroll().listview({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val(),
	                sortable: true, // More info about sortable: https://docs.mobiscroll.com/3-0-0_beta5/listview#!opt-sortable
	                iconSlide: true, // More info about iconSlide: https://docs.mobiscroll.com/3-0-0_beta5/listview#!opt-iconSlide
	                striped: true, // More info about striped: https://docs.mobiscroll.com/3-0-0_beta5/listview#!opt-striped
	                stages: [{ // More info about stages: https://docs.mobiscroll.com/3-0-0_beta5/listview#!opt-stages
	                    percent: 25,
	                    color: 'crimson',
	                    icon: 'checkmark',
	                    text: 'Complete',
	                    action: function (event, inst) {
	                        mobiscroll.$('.md-wo-status', event.target).text('Completed');
	                    }
	                }, {
	                    percent: -50,
	                    color: 'red',
	                    ...
	                    icon: 'plus',
	                    text: 'Spawn',
	                    undo: true, // More info about undo: https://docs.mobiscroll.com/3-0-0_beta5/listview#!methods-undo
	                    action: function (event, inst) {
	                        inst.add(++ids, 'Work order #000' + ids + ' created from WO #000' + mobiscroll.$(event.target).attr('data-id') + '<div class="md-wo-status">Assigned</div>', event.index + 1);
	                    }
	                }, {
	                    percent: -25,
	                    color: 'olive',
	                    ...
	                    text: 'Pending',
	                    action: function (event, inst) {
	                        mobiscroll.$('.md-wo-status', event.target).text('Pending');
	                    }
	                }],
	                onItemAdd: function () { // More info about onItemAdd: https://docs.mobiscroll.com/3-0-0_beta5/listview#!event-onItemAdd
	                    mobiscroll.$('#listviewUpdate-demo_note').hide();
	                },
	                onItemRemove: function () { // More info about onItemRemove: https://docs.mobiscroll.com/3-0-0_beta5/listview#!event-onItemRemove
	                    if (mobiscroll.$('li', this).length < 2) {
	                        mobiscroll.$('#listviewUpdate-demo_note').show();
	                    }
	                }
	            });
	    ...
	    // Sort handle demo script
	     listviewSorthandleInit() {
	        
	
	            // Mobiscroll Listview initialization
	            mobiscroll.$('#listviewSorthandle-demo').mobiscroll().listview({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val(),
	                swipe: false, // More info about swipe: https://docs.mobiscroll.com/3-0-0_beta5/listview#!opt-swipe
	                sortable: { // More info about sortable: https://docs.mobiscroll.com/3-0-0_beta5/listview#!opt-sortable
	                    handle: 'right'
	                },
	                enhance: true // More info about enhance: https://docs.mobiscroll.com/3-0-0_beta5/listview#!opt-enhance
	            });
	
	        },
	
	    // Action menu demo script
	     listviewActionmenuInit() {
	        
	
	            // Mobiscroll Listview initialization
	            mobiscroll.$('#listviewActionmenu-demo').mobiscroll().listview({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val(),
	                enhance: true, // More info about enhance: https://docs.mobiscroll.com/3-0-0_beta5/listview#!opt-enhance
	                actions: [{ // More info about actions: https://docs.mobiscroll.com/3-0-0_beta5/listview#!opt-actions
	                    icon: 'link',
	                    action: function (event, inst) {
	                        notify('Linked');
	                    }
	                ...
	                itemGroups: { // More info about itemGroups: https://docs.mobiscroll.com/3-0-0_beta5/listview#!opt-itemGroups
	                    folder: {
	                        actions: [{ // More info about actions: https://docs.mobiscroll.com/3-0-0_beta5/listview#!opt-actions
	                            icon: 'link',
	                            action: function (event, inst) {
	    ...
	    // Custom Icons demo script
	     ratingIconsInit() {
	            ...
	            // Mobiscroll Rating initialization
	            mobiscroll.$('#ratingIcons-demo').mobiscroll().rating({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val(), // More info about mode: https://docs.mobiscroll.com/3-0-0_beta5/rating#!opt-mode
	                label: 'Rating', // More info about label: https://docs.mobiscroll.com/3-0-0_beta5/rating#!opt-label
	                icon: { // More info about icon: https://docs.mobiscroll.com/3-0-0_beta5/rating#!opt-icon
	                    filled: 'heart'
	                }
	            });
	
	            $('#ratingIcons-show').click(function () {
	                mobiscroll.$('#ratingIcons-demo').mobiscroll('show');
	                return false;
	            });
	
	            $('#ratingIcons-clear').click(function () {
	                mobiscroll.$('#ratingIcons-demo').mobiscroll('clear');
	                return false;
	            });
	    ...
	    // Decimal demo script
	     numberDecimalInit() {
	            ...
	            mobiscroll.$('#numberDecimal-demo').mobiscroll().number({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val(), // More info about mode: https://docs.mobiscroll.com/3-0-0_beta5/number#!opt-mode
	                maxWidth: 100 // More info about maxWidth: https://docs.mobiscroll.com/3-0-0_beta5/number#!opt-maxWidth
	            });
	
	            $('#numberDecimal-show').click(function () {
	                mobiscroll.$('#numberDecimal-demo').mobiscroll('show');
	                return false;
	            });
	
	            $('#numberDecimal-clear').click(function () {
	                mobiscroll.$('#numberDecimal-demo').mobiscroll('clear');
	                return false;
	            });
	    ...
	    //  Decimal demo script
	     numpadDecimalInit() {
	            ...
	            mobiscroll.$('#numpadDecimal-demo').mobiscroll().numpad({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val(),
	                min: 1,
	                scale: 2,
	                preset: 'decimal' // More info about preset: https://docs.mobiscroll.com/3-0-0_beta5/numpad#!opt-preset
	            });
	
	            $('#numpadDecimal-show').click(function () {
	                mobiscroll.$('#numpadDecimal-demo').mobiscroll('show');
	                return false;
	            });
	
	            $('#numpadDecimal-clear').click(function () {
	                mobiscroll.$('#numpadDecimal-demo').mobiscroll('clear');
	                return false;
	            });
	    ...
	    // Currency demo script
	     numpadCurrencyInit() {
	        ...
	        mobiscroll.settings = {
	            ...
	            var stepperPrice = mobiscroll.$('.md-price'),
	                numpadCons = mobiscroll.$('.md-numpad');
	
	            numpadCons.mobiscroll().numpad({
	
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                preset: 'decimal', // More info about preset: https://docs.mobiscroll.com/3-0-0_beta5/numpad#!opt-preset
	                anchor: '.md-price', // More info about anchor: https://docs.mobiscroll.com/3-0-0_beta5/numpad#!opt-anchor
	                min: 10,
	                max: 500,
	                prefix: 'mobiscroll.$',
	                onSet: function (event, inst) { // More info about onSet: https://docs.mobiscroll.com/3-0-0_beta5/numpad#!event-onSet
	            ...
	            stepperPrice.change(function (ev) {
	                ev.target.value = 'mobiscroll.$' + ev.target.value
	                numpadCons.mobiscroll('setVal', ev.target.value);
	            });
	
	            stepperPrice.val('mobiscroll.$' + stepperPrice.val());
	    ...
	    // Time demo script
	     numpadTimeInit() {
	            ...
	            // Mobiscroll Numpad initialization
	            mobiscroll.$('#numpadTime-demo').mobiscroll().numpad({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val(),
	                preset: 'time', // More info about preset: https://docs.mobiscroll.com/3-0-0_beta5/numpad#!opt-preset
	                timeFormat: 'HH:ii A'
	            });
	
	            $('#numpadTime-show').click(function () {
	                mobiscroll.$('#numpadTime-demo').mobiscroll('show');
	                return false;
	            });
	
	            $('#numpadTime-clear').click(function () {
	                mobiscroll.$('#numpadTime-demo').mobiscroll('clear');
	                return false;
	            });
	    ...
	    // Masked Entry - PIN demo script
	     numpadPinInit() {
	            ...
	            // Mobiscroll Numpad initialization
	            mobiscroll.$('#numpadPin-demo').mobiscroll().numpad({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val(),
	                template: 'dddd', // More info about template: https://docs.mobiscroll.com/3-0-0_beta5/numpad#!opt-template
	                allowLeadingZero: true, // More info about allowLeadingZero: https://docs.mobiscroll.com/3-0-0_beta5/numpad#!opt-allowLeadingZero
	                placeholder: '-', // More info about placeholder: https://docs.mobiscroll.com/3-0-0_beta5/numpad#!opt-placeholder
	                mask: '*', // More info about mask: https://docs.mobiscroll.com/3-0-0_beta5/numpad#!opt-mask
	                validate: function (event, inst) { // More info about validate: https://docs.mobiscroll.com/3-0-0_beta5/numpad#!event-validate
	                    return {
	            ...
	            $('#numpadPin-show').click(function () {
	                mobiscroll.$('#numpadPin-demo').mobiscroll('show');
	                return false;
	            });
	
	            $('#numpadPin-clear').click(function () {
	                mobiscroll.$('#numpadPin-demo').mobiscroll('clear');
	                return false;
	            });
	    ...
	    // Setting min and max values demo script
	     datetimeMinmaxInit() {
	            ...
	            // Mobiscroll Date & Time initialization
	            mobiscroll.$('#datetimeMinmax-demo').mobiscroll().date({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val(), // More info about mode: https://docs.mobiscroll.com/3-0-0_beta5/datetime#!opt-mode
	                min: new Date(2014, 8, 15), // More info about min: https://docs.mobiscroll.com/3-0-0_beta5/datetime#!opt-min
	                max: new Date(2024, 8, 14) // More info about max: https://docs.mobiscroll.com/3-0-0_beta5/datetime#!opt-max
	            });
	
	            $('#datetimeMinmax-show').click(function () {
	                mobiscroll.$('#datetimeMinmax-demo').mobiscroll('show');
	                return false;
	            });
	
	            $('#datetimeMinmax-clear').click(function () {
	                mobiscroll.$('#datetimeMinmax-demo').mobiscroll('clear');
	                return false;
	            });
	    ...
	    // Tab menu demo script
	     menustripTabsInit() {
	            ...
	            mobiscroll.$('#menustripTabs-demo').mobiscroll().menustrip({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val(),
	                type: 'tabs', // More info about type: https://docs.mobiscroll.com/3-0-0_beta5/menustrip#!opt-type
	                onItemTap: function (event, inst) { // More info about onItemTap: https://docs.mobiscroll.com/3-0-0_beta5/menustrip#!event-onItemTap
	                    mobiscroll.$('.md-tab-h').removeClass('md-tabs-sel');
	                    mobiscroll.$('.' + mobiscroll.$(event.target).data('tab')).addClass('md-tabs-sel');
	                }
	            });
	
	            // Mobiscroll Menustrip initialization
	            mobiscroll.$('.md-apps-ul').mobiscroll().listview({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	    ...
	    // Icon and Text demo script
	     imageIconsInit() {
	            ...
	            // Mobiscroll Image initialization
	            mobiscroll.$('#imageIcons-demo').mobiscroll().image({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val(), // More info about mode: https://docs.mobiscroll.com/3-0-0_beta5/image#!opt-mode
	                placeholder: 'Please Select ...', // More info about placeholder: https://docs.mobiscroll.com/3-0-0_beta5/image#!opt-placeholder
	                showLabel: false, // More info about showLabel: https://docs.mobiscroll.com/3-0-0_beta5/image#!opt-showLabel
	                enhance: true // More info about enhance: https://docs.mobiscroll.com/3-0-0_beta5/image#!opt-enhance
	            });
	
	            $('#imageIcons-show').click(function () {
	                mobiscroll.$('#imageIcons-demo').mobiscroll('show');
	                return false;
	            });
	
	            $('#imageIcons-clear').click(function () {
	                mobiscroll.$('#imageIcons-demo').mobiscroll('clear');
	                return false;
	            });
	    ...
	    // Step demo script
	     numberStepInit() {
	            ...
	            // Mobiscroll Number initialization
	            mobiscroll.$('#numberStep-demo').mobiscroll().number({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val(), // More info about mode: https://docs.mobiscroll.com/3-0-0_beta5/number#!opt-mode
	                layout: 'fixed', // More info about layout: https://docs.mobiscroll.com/3-0-0_beta5/number#!opt-layout
	                step: 5 // More info about step: https://docs.mobiscroll.com/3-0-0_beta5/number#!opt-step
	            });
	
	            $('#numberStep-show').click(function () {
	                mobiscroll.$('#numberStep-demo').mobiscroll('show');
	                return false;
	            });
	
	            $('#numberStep-clear').click(function () {
	                mobiscroll.$('#numberStep-demo').mobiscroll('clear');
	                return false;
	            });
	    ...
	    // Dialog demo script
	     widgetDialogInit() {
	            ...
	            mobiscroll.$('#widgetDialog-demo').mobiscroll().widget({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val(),
	                anchor: $('#widgetDialog-show'), // More info about anchor: https://docs.mobiscroll.com/3-0-0_beta5/widget#!opt-anchor
	                buttons: [{ // More info about buttons: https://docs.mobiscroll.com/3-0-0_beta5/widget#!opt-buttons
	                    text: 'Great',
	                    handler: 'set'
	                }, {
	                ...
	                onBeforeShow: function (event, inst) { // More info about onBeforeShow: https://docs.mobiscroll.com/3-0-0_beta5/widget#!event-onBeforeShow
	                    var s = inst.settings;
	            ...
	            $('#widgetDialog-show').click(function () {
	                mobiscroll.$('#widgetDialog-demo').mobiscroll('show');
	                return false;
	            });
	    ...
	    // Alert message demo script
	     widgetMessageInit() {
	            ...
	            // Mobiscroll Widget initialization
	            mobiscroll.$('#widgetMessage-demo').mobiscroll().widget({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val(),
	                anchor: mobiscroll.$('#widgetMessage-show'), // More info about anchor: https://docs.mobiscroll.com/3-0-0_beta5/widget#!opt-anchor
	                buttons: [{ // More info about buttons: https://docs.mobiscroll.com/3-0-0_beta5/widget#!opt-buttons
	                    text: 'Agree',
	                    handler: 'set'
	                }, {
	            ...
	            $('#widgetMessage-show').click(function () {
	                mobiscroll.$('#widgetMessage-demo').mobiscroll('show');
	                return false;
	            });
	    ...
	    // Custom Units demo script
	     scrollerCustomunitsInit() {
	            ...
	            var units = ['oz', 'g', 'serving'],
	                ...
	                wheel = [
	                    [{
	                        circular: false, // More info about circular: https://docs.mobiscroll.com/3-0-0_beta5/scroller#!opt-circular
	            ...
	            mobiscroll.$('#scrollerCustomunits-demo').mobiscroll().scroller({
	                theme: $('#theme').val(), // Specify theme like: theme: 'ios' or omit setting to use default
	                lang: $('#language').val(), // Specify language like: lang: 'pl' or omit setting to use default
	                display: $('#display').val(), // Specify display mode like: display: 'bottom' or omit setting to use default
	                mode: $('#mode').val(), // More info about mode: https://docs.mobiscroll.com/3-0-0_beta5/scroller#!opt-mode
	                wheels: wheel, // More info about wheels: https://docs.mobiscroll.com/3-0-0_beta5/scroller#!opt-wheels
	                validate: function (event, inst) { // More info about validate: https://docs.mobiscroll.com/3-0-0_beta5/scroller#!event-validate
	                    var i,
	                        mult = 1,
	                        index = event.index,
	                    ...
	                    return {
	                        disabled: [ // More info about disabled: https://docs.mobiscroll.com/3-0-0_beta5/scroller#!opt-disabled
	                            [], disabled, []
	                        ]
	                    }
	                },
	            ...
	            $('#scrollerCustomunits-show').click(function () {
	                mobiscroll.$('#scrollerCustomunits-demo').mobiscroll('show');
	                return false;
	            });
	
	            $('#scrollerCustomunits-clear').click(function () {
	                mobiscroll.$('#scrollerCustomunits-demo').mobiscroll('clear');
	                return false;
	            });
	    ...
	    // Stepper demo script
	     formsStepperInit() {
	        ...
	        mobiscroll.settings = {
	            ...
	            var cbAllow = mobiscroll.$('.md-allow'),
	                stepperLuggage = mobiscroll.$('.md-luggage'),
	                stepperCons = mobiscroll.$('.md-consumption'),
	                numpadCons = mobiscroll.$('.md-numpad');
	    ...
	    // Progress demo script
	     formsProgressInit() {
	        ...
	        mobiscroll.settings = {
	            ...
	            var downloadInst = mobiscroll.$('#formsProgress-download').mobiscroll('getInst'),
	                interval,
	                i;
	            ...
	            var inst = mobiscroll.$('#formsProgress-progress').mobiscroll('getInst'),
	                val;
	            ...
	            var upInterval,
	                ...
	                uploadInst = mobiscroll.$('#formsProgress-uploadProg').mobiscroll('getInst');
	            ...
	            $('.md-upload .mbsc-progress-step-label').each(function (i, v) {
	                mobiscroll.$(v).text(uploadList[i]);
	            });
	            ...
	            var labelList = ['Cart', 'Signup', 'Checkout', 'Success'],
	                cartInst = mobiscroll.$('#formsProgress-cartProg').mobiscroll('getInst');
	
	            $('.md-demo .mbsc-progress-step-label').each(function (i, v) {
	                mobiscroll.$(v).text(labelList[i]);
	            });
